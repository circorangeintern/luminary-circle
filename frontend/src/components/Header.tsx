...
export default function Header() {
  ...
  return (
    <header className="bg-ink flex items-center justify-between px-4 sm:px-8 lg:px-16 gap-6 sticky top-0 z-50 h-16 lg:h-20">
      ...
      <ul
        ...
        } lg:translate-x-0 fixed lg:static inset-0 lg:inset-auto bg-ink lg:bg-transparent flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-8 lg:gap-10 z-50 transition-transform duration-300 list-none`}
      >
        {links.map((l) => (
          <li key={l.to}>
            <NavLink
      ...
      <div className="hidden lg:flex items-center gap-4 shrink-0">
        <div className="flex items-center gap-2 bg-input-bg border border-input-border rounded-lg px-4 py-3 w-44">
        ...
        <Link to="/signin" className="bg-red text-white px-7 py-3 rounded-lg text-sm whitespace-nowrap hover:brightness-110 transition">
          Sign in
        </Link>
      </div>
    </header>
